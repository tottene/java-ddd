...
public class CategoryTest {
    ...
    @Test
    public void givenAValidDescription_whenCallNewCategoryValidate_thenShouldReceiveError() {
        final var expectedName = "Movies";
    ...
    @Test
    public void givenAValidFalseIsActive_whenCallNewCategoryValidate_thenShouldReceiveOK() {
        final var expectedName = "Movies";
    ...
    @Test
    public void givenAValidCategory_whenCallUpdate_thenReturnUpdatedCategory() throws InterruptedException {
        final var expectedName = "Movies";
        final var expectedDescription = "Most watched category";
        final var expectedIsActive = true;

        final var aCategory = Category.newCategory("Movie", "Category", expectedIsActive);
    ...
    @Test
    public void givenAValidCategory_whenCallUpdateToInactived_thenReturnUpdatedCategory() throws InterruptedException {
        final var expectedName = "Movies";
        final var expectedDescription = "Most watched category";
        final var expectedIsActive = false;

        final var aCategory = Category.newCategory("Movie", "Category", true);
    ...
    public void givenAValidCategory_whenCallUpdateWithInvalidParams_thenReturnCategoryUpdated() throws InterruptedException {
        ...
        final var aCategory = Category.newCategory("Movies", "Category", expectedIsActive);
