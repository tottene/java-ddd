...
public class CreateGenreUseCaseTest extends UseCaseTest {
    ...
    @Test
    public void givenAValidCommandWitInactiveGenre_whenCallsCreateGenre_thenShouldReturnGenreId() {
        // given
        final var expectedName = "Action";
    ...
    @Test
    public void giveAnInvalidEmptyName_whenCallsCreateGenre_thenShouldReturnDomainException() {
        // given
        final String expectedName = " ";
        final var expectedIsActive = true;
        final var expectedCategories = asString(List.<CategoryID>of());
    ...
    @Test
    public void giveAnInvalidNullName_whenCallsCreateGenre_thenShouldReturnDomainException() {
        // given
        final var expectedIsActive = true;
        final var expectedCategories = asString(List.<CategoryID>of());
        ...
        final var aCommand = CreateGenreCommand.with(null, expectedIsActive, expectedCategories);
    ...
    @Test
    public void giveAValidCommand_whenCallsCreateGenreAndCategoriesDoesNotExists_thenShouldReturnDomainException() {
        // given
        final var movies = CategoryID.from("123");
        final var series = CategoryID.from("456");
        final var musical = CategoryID.from("789");
        final var expectedName = "Action";
        final var expectedIsActive = true;
        final var expectedCategories = List.of(movies, series, musical);
    ...
    @Test
    public void giveAnInvalidName_whenCallsCreateGenreAndCategoriesDoesNotExists_thenShouldReturnDomainException() {
        // given
        final var movies = CategoryID.from("123");
        final var series = CategoryID.from("456");
        final var musical = CategoryID.from("789");
